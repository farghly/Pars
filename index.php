    ...
    <div id="header">
        ...
        <div class="shell">
            ...
            <div id="top">
                ...
                <!--<center><h3 style="color:white;"><div id="txt"></div></h3></center> -->
...
-->
        <form method="post" action="index.php">
            <table>
                ...
                <tr>
                    <td> WaitTime : <input type="text" name="waittime" value="<?php echo $waittime; ?>" /></td>
                    <td> Interval <a href="calc.php"> [calculation*] :</a><input type="text" name="interval"
                            value="<?php echo $interval; ?>" /></td>
                    <td> Caller ID : <input type="text" name="caller_id" value="<?php echo $caller_id; ?>" /></td>
                    <td>
                    <td> Prefix: <input type="text" name="prefix" value="<?php echo $prefix; ?>" /></td>
                </tr>
                ...
                <tr>
                    <td>Context : <input type="text" name="context1" value="<?php echo $context1; ?>" /></td>
                    <td>Extension : <input type="text" name="exten1" value="<?php echo $exten1; ?>" /></td>
                </tr>
                <tr>
                    <td>Press Number 2 : </td>
                </tr>

                <tr>
                    <td>Context : <input type="text" name="context2" value="<?php echo $context2; ?>" /></td>
                    <td>Extension : <input type="text" name="exten2" value="<?php echo $exten2; ?>" /></td>
                </tr>
    ...
    <div id="borderDemo">
        ...
        <h4><a href="numbers-sample.csv" class="fa fa-download"></a><a href="numbers-sample.csv" download> Download
                Example File </a></h4>
    ...
    <div id="borderDemo">
        ...
        <button onclick="moresFunction()" id="myBtn" class="my1Button"> <i class="fa fa-eye" aria-hidden="true"></i>
            Show </button>
        <!--This is a comment. Comments are not displayed in the browser-->
        <!--<form action="index.php" method="post"> <input type="submit" name="remve_file" value="Delete All Logs" class="button button1 fa fa-refresh"></form> -->
		...
		-->
        <button class="myButton" onclick="document.getElementById('id01').style.display='block'"><i class="fa fa-remove"
                ...
                <div class="container">
                    ...
                    <div class="clearfix">
                        <button type="button" onclick="document.getElementById('id01').style.display='none'"
                            class="cancelbtn">Cancell</button>
...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lalezar:wght@300&family=Cairo:wght@200&family=Lalezar:wght@300&family=Tajawal:wght@300&display=swap"
        rel="stylesheet">
